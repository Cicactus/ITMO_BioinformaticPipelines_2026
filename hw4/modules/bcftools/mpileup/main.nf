process BCFTOOLS_MPILEUP {
    ...
    // FIX: Filter the input path list to only include files ending in .bam
    def bam_files = bam.findAll { it.toString().endsWith('.bam') }.join(' ')
    ...
    bcftools \
        ...
        ${mpileup} \
        | bcftools call -m --output-type v ${args2} ${intervals_call_cmd} \
